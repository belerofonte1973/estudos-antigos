...
<Figura
	src="/imagens/josue/02-josue-detem-o-sol-sobre-gibeao.webp"
	alt="Josué detém o sol sobre Gibeão"
	titulo="Josué detém o sol sobre Gibeão"
	legenda="John Martin pinta a ordem de Js 10,12-13 — sol, detém-te sobre Gibeão — como um vasto panorama de montanhas e nuvens, com a batalha reduzida a pontos na imensidão. O dossiê usa a obra porque ela faz o inverso da leitura devocional: o milagre não é espetáculo, é o quadro inteiro parado."
	passagem="Js 10,12-14"
	artista="John Martin"
	data="circa 1840"
	tecnica="óleo sobre tela"
	acervo="Google Arts & Culture (Google Cultural Institute)"
	fonte="https://commons.wikimedia.org/wiki/File%3AJohn_Martin_-_Joshua_Commanding_the_Sun_to_Stand_Still_-_Google_Art_Project.jpg"
	licenca="Public domain"
/>
...
<Figura
	src="/imagens/josue/03-raabe-e-os-dois-espias.webp"
	alt="Raabe e os dois espias"
	titulo="Raabe e os dois espias"
	legenda="Tissot representa Js 2,1-21: Raabe esconde os espias e os faz descer pela janela, com o cordão vermelho preso à muralha. O dossiê usa a cena porque o livro faz dela o primeiro acerto do relato de conquista — uma mulher de Jericó é quem reconhece o que os israelitas ainda vão descobrir."
	passagem="Js 2,1-21"
	artista="James Tissot"
	data="between circa 1896 and circa 1902"
	tecnica="gouache sobre cartão"
	acervo="Jewish Museum, Nova York (Tissot, c. 1896-1902)"
	fonte="https://commons.wikimedia.org/wiki/File%3ATissot_The_Harlot_of_Jericho_and_the_Two_Spies.jpg"
	licenca="Public domain"
/>
...
<Figura
	src="/imagens/josue/04-a-divisao-da-terra-de-canaa-entre-as-doze-tribos.webp"
	alt="A divisão da terra de Canaã entre as doze tribos"
	titulo="A divisão da terra de Canaã entre as doze tribos"
	legenda="Mapa de John Canne para a repartição da terra entre as tribos, conservado na Coleção Cartográfica Eran Laor da Biblioteca Nacional de Israel. O dossiê usa a estampa ao tratar de Js 13-21: as longas listas de limites do livro são, na tradição europeia, o material com que se desenha a terra — e cada mapa é uma tentativa de fazer a lista virar geografia."
	passagem="Js 13-21"
	artista="John Canne"
	tecnica="mapa impresso (gravura)"
	acervo="Biblioteca Nacional de Israel, Coleção Eran Laor de Cartografia"
	fonte="https://commons.wikimedia.org/wiki/File%3AJohn_Canne%2C_A_view_of_the_division_of_the_land_of_Canaan_among_the_twelve_tribes_of_Israel_the_situation_of_the_city_and_sanctuary_%26c_as_described_by_Josephus_antiquities_%28FL45602025_3935134%29.jpg"
	licenca="Public domain"
/>
...
<Figura
	src="/imagens/josue/05-a-colina-de-tell-es-sultan-em-jerico.webp"
	alt="A colina de Tell es-Sultan, em Jericó"
	titulo="A colina de Tell es-Sultan, em Jericó"
	legenda="A colina de Tell es-Sultan, em Jericó, é o sítio cujas escavações desfizeram a leitura direta do capítulo 6: as muralhas mais conhecidas são muito anteriores à data em que se costuma situar a entrada de Israel. O dossiê usa a fotografia na seção de ciência porque o lugar onde a narrativa põe o milagre é exatamente o lugar onde a arqueologia põe a pergunta."
	passagem="contexto arqueológico (cf. Js 6)"
	artista="Diego Delso"
	data="2011-09-29"
	tecnica="sítio arqueológico"
	acervo="Tell es-Sultan, Jericó; fotografia de Diego Delso, CC BY-SA 3.0"
	fonte="https://commons.wikimedia.org/wiki/File%3ATell_es-Sultan%2C_Jericho%2C_Palestine2.jpg"
...
<Figura
	src="/imagens/josue/06-a-estela-de-merneptah-no-museu-egipcio.webp"
	alt="A estela de Merneptah no Museu Egípcio"
	titulo="A estela de Merneptah no Museu Egípcio"
	legenda="A inscrição de Merneptah (c. 1208 a.C.) é o testemunho egípcio mais antigo do nome Israel como povo no país, e o dossiê a usa na seção de ciência para delimitar o quadro histórico do livro de Josué: o que ela documenta é a existência do nome no fim do século XIII a.C., não qualquer episódio da conquista."
	...
	fonte="https://commons.wikimedia.org/wiki/File%3AMerneptah_Stele_2022_11.jpg"

---
titulo: 'Os hebreus foram escravos no Egito?'
pergunta: 'Os hebreus foram escravos no Egito?'
descricao: 'A arqueologia não encontrou vestígio de êxodo em massa. A Estela de Merneptah (c. 1208 a.C.) atesta Israel em Canaã — que é outra coisa.'
respostaRapida: 'Não há evidência arqueológica de um êxodo em massa do Egito. O que existe é a Estela de Merneptah (c. 1208 a.C.), a primeira menção extrabíblica a Israel, e ela situa Israel já em Canaã, não no Egito. Isso não prova que nenhum grupo tenha saído do Egito, mas não sustenta a narrativa de uma fuga coletiva de centenas de milhares de pessoas.'
area: biblia
tags: [Exodo, Merneptah, arqueologia, Finkelstein, historiedade]
data: 2026-09-07
destaque: 5
dossie: biblia/exodo
fontes:
...
O debate completo, com as posições de Kitchen e Finkelstein e a bibliografia, está no [dossiê do Êxodo](/biblioteca/biblia/exodo/).

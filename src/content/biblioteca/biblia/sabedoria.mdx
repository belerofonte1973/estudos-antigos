...
<Figura
	src="/imagens/sabedoria/01-salomao-pede-a-sabedoria.webp"
	alt="Salomão pede a sabedoria"
	titulo="Salomão pede a sabedoria"
	legenda="A cena é a oração de Salomão pela sabedoria, que a Sabedoria de Salomão reescreve em primeira pessoa: 'orei, e a prudência me foi dada' (Sb 7,7), e 'sendo eu um menino bem dotado, coube-me uma boa alma' (Sb 8,19-20). O dossiê compara esta oração com 1Rs 3, e é aí que a questão da antropologia grega — a alma que precede o corpo — entra no debate."
	passagem="Sb 7,7-14; 8,19-20 (cf. 1Rs 3,5-14)"
	artista="anônimo"
	tecnica="gravura"
	acervo="Netherlands Institute for Art History (RKD, id. digital 2792)"
	fonte="https://commons.wikimedia.org/wiki/File%3ASolomon_prays_for_wisdom.jpg"
...
<Figura
	src="/imagens/sabedoria/02-o-espirito-da-sabedoria.webp"
	alt="O Espírito da Sabedoria"
	titulo="O Espírito da Sabedoria"
	legenda="Primeira prancha da série sobre o Espírito da Sabedoria, publicada por Adriaen Collaert a partir de composição de Jan van der Straet (c. 1595): Salomão julga as duas mães e manda dividir a criança (1Rs 3,16-28). A obra mostra a recepção do tema da sabedoria régia na gravura flamenga — o mesmo Salomão que o livro da Sabedoria põe a falar na primeira pessoa e cuja sabedoria Sb 7-9 descreve como dom."
	passagem="Sb 7,7-14 (cf. 1Rs 3,16-28)"
	artista="After: Jan van der Straet Published by: Adriaen Collaert"
	data="circa 1595"
	tecnica="gravura"
	acervo="British Museum, Londres (1937,0915.309)"
	fonte="https://commons.wikimedia.org/wiki/File%3ASpiritus_Sapientiae_%28The_Spirit_of_Wisdom%29_%28BM_1937%2C0915.309%29.jpg"
	licenca="Public domain"
/>
...
<Figura
	src="/imagens/sabedoria/04-salomao-e-a-rainha-de-saba.webp"
	alt="Salomão e a rainha de Sabá"
	titulo="Salomão e a rainha de Sabá"
	legenda="Iluminura de 1452 com a rainha de Sabá diante de Salomão (1Rs 10,1-13), a visita em que a rainha vem 'provar com enigmas' a sabedoria do rei. A cena não está no livro da Sabedoria, mas é a matriz narrativa da fama sapiencial de Salomão que o livro pressupõe quando põe na boca dele o discurso sobre a sabedoria (§4.3)."
	passagem="Sb 7-9 (cf. 1Rs 10,1-13)"
	artista="Miscellaneous Items in High Demand, PPOC, Library of Congress"
	data="1452"
	tecnica="iluminura"
	acervo="Library of Congress, Washington (divisão de Gravuras e Fotografias, LCCN 2002723391)"
	fonte="https://commons.wikimedia.org/wiki/File%3AIllumination_of_Solomon_and_Sheba_-_Old_Testament_I_LCCN2002723391.jpg"
	licenca="Public domain"
/>

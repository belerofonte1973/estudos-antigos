...
<Figura
	src="/imagens/lamentacoes/04-manuscrito-polifonico-das-lamentacoes.webp"
	alt="Manuscrito polifônico das Lamentações"
	titulo="Manuscrito polifônico das Lamentações"
	legenda="Página de manuscrito com a música polifônica das Lamentações de Jeremias, atribuída a Carpentras e conservada em arquivo vaticano. O dossiê usa a página para mostrar que as Lamentações são um texto feito para ser entoado: a sua circulação medieval e moderna passa mais pela liturgia cantada do que pela pintura."
	passagem="Lm 1,1-2 (recepção litúrgica)"
	artista="Unknown author Unknown author"
	tecnica="manuscrito musical sobre pergaminho"
	acervo="Arquivo do Vaticano (imagem de domínio público)"
	fonte="https://commons.wikimedia.org/wiki/File%3ACarpentras_lamentations.jpg"
	licenca="Public domain"
/>

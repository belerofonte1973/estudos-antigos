...
<Figura
	src="/imagens/rute/02-rute-encontra-booz.webp"
	alt="Rute encontra Booz"
	titulo="Rute encontra Booz"
	legenda="Página do manuscrito W.106 da Walters Art Museum, iluminado por William de Brailes em torno de 1250, com duas cenas da história de Rute: ela colhendo espigas e o encontro com Booz. O dossiê usa a iluminura porque mostra a história lida dentro de um livro de horas, com Rute incorporada à devoção medieval como figura exemplar de fidelidade."
	passagem="Rt 2,4-16"
	artista="William de Brailes"
	data="circa 1250"
	tecnica="iluminura sobre pergaminho"
	acervo="Walters Art Museum, Baltimore (W.106)"
	fonte="https://commons.wikimedia.org/wiki/File%3AWilliam_de_Brailes_-_Top_-_Ruth_Meets_Boaz_as_she_gleans_%28Ruth_2_-4-16%29_-_Walters_W10618R_-_Full_Page.jpg"
	licenca="Public domain"
/>
...
<Figura
	src="/imagens/rute/04-rute-e-noemi.webp"
	alt="Rute e Noemi"
	titulo="Rute e Noemi"
	legenda="Jan Victors, discípulo de Rembrandt, pinta em 1653 as duas mulheres de Rt 1: a viúva Noemi, que se diz amargurada, e Rute, que se recusa a deixá-la — aonde fores irei, onde ficares ficarei (Rt 1,16). O dossiê usa a obra porque é a decisão do primeiro capítulo que sustenta tudo o que vem depois, inclusive a genealogia de Davi no fim do livro."
	passagem="Rt 1,1-22"
	artista="Jan Victors"
	data="1653"
	tecnica="óleo sobre tela"
	acervo="Coleção particular; imagem de catálogo da Sotheby's"
	fonte="https://commons.wikimedia.org/wiki/File%3A%27Ruth_and_Naomi%27_by_Jan_Victors%2C_1653.jpg"
	licenca="Public domain"
/>
...
<Figura
	src="/imagens/rute/05-rute-e-noemi-a-caminho-de-belem.webp"
	alt="Rute e Noemi a caminho de Belém"
	titulo="Rute e Noemi a caminho de Belém"
	legenda="Obra de Philip Hermogenes Calderon no Yale Center for British Art (B2010.27.8), com as duas mulheres voltando de Moab para Belém no início de Rt 1 — chegaram a Belém no princípio da colheita da cevada (Rt 1,22). O dossiê usa a imagem na seção de recepção porque o século XIX leu a história como paradigma da estrangeira que se integra, tema central das discussões atuais sobre o livro."
	passagem="Rt 1,19-22"
	artista="Philip Hermogenes Calderon"
	tecnica="óleo sobre tela"
	acervo="Yale Center for British Art, New Haven (B2010.27.8)"
	fonte="https://commons.wikimedia.org/wiki/File%3APhilip_Hermogenes_Calderon_-_Ruth_and_Naomi_-_B2010.27.8_-_Yale_Center_for_British_Art.jpg"
	licenca="CC0"
/>

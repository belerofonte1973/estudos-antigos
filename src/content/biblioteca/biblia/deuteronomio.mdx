...
<Figura
	src="/imagens/deuteronomio/01-a-morte-de-moises-no-monte-nebo.webp"
	alt="A morte de Moisés no monte Nebo"
	titulo="A morte de Moisés no monte Nebo"
	legenda="Gravura holandesa de c. 1582-1583, conservada no Rijksmuseum: Moisés morre no alto do monte Nebo depois de ver a terra que não atravessará (Dt 34,1-5). A cena é o desfecho de Deuteronômio e o lugar onde o dossiê discute o que o livro faz com seu protagonista — o mediador que fala com Deus face a face e, no fim, não entra na terra."
	passagem="Dt 34,1-8"
	artista="Rijksmuseum"
	data="between 1582 and 1583"
	tecnica="gravura (buril)"
	acervo="Rijksmuseum, Amsterdã (RP-P-1966-41)"
	fonte="https://commons.wikimedia.org/wiki/File%3ADood_van_Mozes_Sc%C3%A8nes_uit_het_Oude_Testament_%28serietitel%29%2C_RP-P-1966-41.jpg"
	licenca="CC0"
/>
...
<Figura
	src="/imagens/deuteronomio/02-rolo-da-tora-do-museu-de-casale-monferrato.webp"
	alt="Rolo da Torá do museu de Casale Monferrato"
	titulo="Rolo da Torá do museu de Casale Monferrato"
	legenda="Rolo da Torá dos séculos XVII-XVIII, em pergaminho, exposto no museu da sinagoga de Casale Monferrato, na Itália. O dossiê usa o objeto ao tratar do Shemá (Dt 6,4-9): é nos rolos da liturgia que a confissão de fé de Deuteronômio continua sendo lida e ensinada, e o objeto mostra que a ordem de escrever a palavra nas portas da casa tem história material."
	passagem="Dt 6,4-9"
	artista="FLLL"
	data="2011-12-21"
	tecnica="rolo de pergaminho manuscrito (séc. XVII-XVIII)"
	acervo="Museu da Sinagoga de Casale Monferrato, Itália; fotografia de FLLL, CC BY-SA 3.0"
	fonte="https://commons.wikimedia.org/wiki/File%3ACasale_Monferrato_-_Synagogue_-Sefer_Torah.jpg"
...
<Figura
	src="/imagens/deuteronomio/03-mosaicos-da-basilica-do-monte-nebo.webp"
	alt="Mosaicos da basílica do monte Nebo"
	titulo="Mosaicos da basílica do monte Nebo"
	legenda="Mosaicos do século VI da basílica do Memorial de Moisés, no monte Nebo, na Jordânia, onde a tradição situa a morte de Moisés. O dossiê usa a imagem na seção de recepção porque documenta como o lugar de Dt 34 foi marcado, construído e percorrido na Antiguidade tardia: o texto virou topografia."
	passagem="Dt 34,1-6 (recepção)"
	artista="Osama Shukir Muhammed Amin FRCP(Glasg)"
	data="2019-01-18 14:42:46"
	tecnica="mosaico (século VI)"
	acervo="Basílica do Memorial de Moisés, monte Nebo, Jordânia; fotografia de Osama Shukir Muhammed Amin, CC BY-SA 4.0"
	fonte="https://commons.wikimedia.org/wiki/File%3AMosaics_of_the_Basilica%2C_mid-6th_century_CE._Inside_the_Memorial_Church_of_Moses%2C_Mount_Nebo%2C_Jordan.jpg"
...
<Figura
	src="/imagens/deuteronomio/04-o-tratado-de-cades.webp"
	alt="O tratado de Cades"
	titulo="O tratado de Cades"
	legenda="Tábua do tratado concluído entre Ramsés II e o rei hitita em 1269 a.C., no Museu do Oriente Antigo em Istambul. O dossiê o usa na seção de comparação porque a estrutura desses tratados de vassalagem — preâmbulo, história das relações, estipulações, testemunhas e maldições — é o modelo com que se costuma comparar a forma da aliança em Deuteronômio: as bênçãos e maldições do fim do livro não são ornamento, são cláusula."
	passagem="contexto do Antigo Oriente Próximo (cf. Dt 28)"
	artista="Osama Shukir Muhammed Amin FRCP(Glasg)"
	data="2018-04-24 13:14:08"
	tecnica="argila inscrita (1269 a.C.)"
	acervo="Museu do Oriente Antigo, Istambul; fotografia de Osama Shukir Muhammed Amin, CC BY-SA 4.0"
	fonte="https://commons.wikimedia.org/wiki/File%3A1._Part_of_the_clay_tablet_of_Kadesh_Treaty%2C_written_in_Akkadian._1269_BCE._From_Bo%C4%9Fazk%C3%B6y%2C_Turkey._Clay_tablet._Museum_of_the_Ancient_Orient%2C_Istanbul%2C_Turkey.jpg"
	licenca="CC BY-SA 4.0"
/>
...
**Contagem e equilíbrio.** Esferas: católico ocidental (Beda, a *Glossa*, Nicolau de Lira, Cornélio a Lapide — 4); católico oriental / grego patrístico (Orígenes, Teodoreto, Crisóstomo [uso homilético], Efrém [atribuição recusada] — 4); ortodoxo (a catena, Lopukhin, *Orthodox Study Bible* — 3); protestante (Lutero, Calvino, Matthew Henry, Keil–Delitzsch, Craigie, Christensen, McConville — 7); judaico (Rashi, Ramban, Tigay, Weinfeld — 4); islâmico (remissão a §11.6); não confessional / de método secular (Wellhausen, Niditch, Assmann, Levinson — 4). **Desequilíbrio declarado:** a esfera protestante tem mais nomes porque é a que mais produz séries de comentários a um livro do AT — é assimetria de mercado editorial, não de mérito; e a esfera ortodoxa quase não tem comentário moderno a Dt, o que é **fato estrutural da tradição**, não lacuna de pesquisa. O Oriente entra por fonte primária (Orígenes, Teodoreto, a catena), como o método exige.
...
<Figura
	src="/imagens/deuteronomio/05-a-estela-de-mesha.webp"
	alt="A estela de Mesha"
	titulo="A estela de Mesha"
	legenda="A estela erguida pelo rei moabita Mesha (c. 840 a.C.), no Louvre, narra em moabita a guerra contra Israel e menciona a dinastia de Onri — é uma das poucas inscrições que contam, do outro lado, um conflito também relatado na Bíblia. O dossiê a usa na seção de ciência porque mostra que a linguagem da guerra, da aliança e da fidelidade divina que Deuteronômio emprega para Israel era corrente entre seus vizinhos."
	passagem="contexto epigráfico (cf. Dt 28; 2Rs 3)"
	artista="Mbzt"
	data="2020-10-22 16:58:54"
	tecnica="pedra basáltica com inscrição (c. 840 a.C.)"
	acervo="Musée du Louvre, Paris (AO 5066); fotografia de Mbzt, CC BY-SA 4.0"
	fonte="https://commons.wikimedia.org/wiki/File%3AF4171_Louvre_stele_de_Mesha_AO5066_rwk.jpg"
	licenca="CC BY-SA 4.0"
/>
...
*2 livre · 8 emprestimo · 2 biblioteca · 1 compra.*

| Obra | Acesso | Onde |
| --- | --- | --- |
| de Wette (1805), tese sobre Dt como "livro achado" de Josias | <SeloAcesso tipo="livre" /> | [britannica.com](https://www.britannica.com/biography/Wilhelm-M-L-de-Wette) |
| von Rad, Das formgeschichtliche Problem des Hexateuch (Kohlhammer, 1938) | <SeloAcesso tipo="livre" /> | [ixtheo.de](https://www.ixtheo.de/Record/143610694) |
| Noth, Überlieferungsgeschichtliche Studien (Niemeyer, 1943) | <SeloAcesso tipo="emprestimo" /> | [Open Library](https://openlibrary.org/books/OL19814792M) |
| Weinfeld, Deuteronomy and the Deuteronomic School (Clarendon, 1972) | <SeloAcesso tipo="emprestimo" /> | [Open Library](https://openlibrary.org/works/OL3744015W) |
| Levinson, Deuteronomy and the Hermeneutics of Legal Innovation (OUP, 1997) | <SeloAcesso tipo="emprestimo" /> | [Open Library](https://openlibrary.org/works/OL3349578W) |
| Mayes, Deuteronomy (NCB; 1979/1981) | <SeloAcesso tipo="emprestimo" /> | [Open Library](https://openlibrary.org/works/OL6437768W) |
| Nelson, Deuteronomy: A Commentary (OTL, Westminster John Knox, 2002) | <SeloAcesso tipo="emprestimo" /> | [Open Library](https://openlibrary.org/works/OL1918496W) |
| Tigay, Deuteronomy (JPS Torah Commentary, 1996) | <SeloAcesso tipo="emprestimo" /> | [Open Library](https://openlibrary.org/works/OL3237772W) |
| Kline, Treaty of the Great King (Eerdmans, 1963) | <SeloAcesso tipo="emprestimo" /> | [Open Library](https://openlibrary.org/works/OL6942220W) |
| Moshe Weinfeld — Deuteronomy 1-11 | <SeloAcesso tipo="emprestimo" /> | [Internet Archive](https://archive.org/details/deuteronomy111an00mosh) |
| Jan Assmann ; translated by Robert Savage — The price of monotheism | <SeloAcesso tipo="biblioteca" /> | [Open Library](https://openlibrary.org/isbn/9780804761604) |
| Doubleday 1991 / Yale UP 2008). Yale UP: [ | <SeloAcesso tipo="biblioteca" /> | [Open Library](https://openlibrary.org/isbn/9780300139433) |
| Block, Deuteronomy (NIVAC; Zondervan, 2012) | <SeloAcesso tipo="compra" /> | [zondervanacademic.com](https://zondervanacademic.com/products/deuteronomy) |
